...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get groupWelcome => 'グループへようこそ！メンバーとチャットしたりファイルを共有したりできます。';
  @override
  String get channelWelcome => 'チャンネルへようこそ！重要なお知らせやニュースがここに投稿されます。';
  @override
  ...
  String get closeActionMinimizeToTraySubtitle =>
      'ウィンドウを閉じるとシステムトレイに最小化されバックグラウンドで実行を続けます';
  @override
  ...
  @override
  String get qrApprovalTitle => 'スマートフォンでログインを確認';

  @override
  String get qrApprovalDesc => 'QRコードを認識しました。Xaneoモバイルアプリでログインを承認してください。';

  @override
  String get qrVerificationCodeLabel => '確認コード';

  @override
  String get qrVerificationCodeHint =>
      'このコードがスマートフォンに表示されたコードと一致することを確認してください。';
  ...
  String get codeInstructionText =>
      '6桁の認証コードはXCの「Xaneo Notifications」ボット、またはXCでコードを受信できない場合はメールに送信されます。';
  ...
  @override
  String requestCodeViaEmailIn(int seconds) => '$seconds秒後にメールでコードをリクエスト';

  @override
  String requestCodeViaPasswordIn(int seconds) => '$seconds秒後にパスワードでログイン';

  @override
  String get loginWithPasswordLink => 'パスワードでログイン';

  @override
  String get cantLoginSendToEmail => 'ボットでログインできませんか？メールにコードを送信';

  @override
  String get resendCodeToEmail => 'メールにコードを再送信';

  @override
  String get codeSentToBot => '「Xaneo Notifications」チャットにコードを送信しました。';

  @override
  String emailCodeSent(String email) =>
      email.isNotEmpty ? 'コードがメール $email に送信されました' : 'コードがメールに送信されました';

  @override
  String get emailCodeFailed => 'メールへのコード送信に失敗しました';

  @override
  String get enterUsernameErr => 'ユーザー名または確認済みメールアドレスを入力してください。';

  @override
  String get sendCodeFailedErr => 'コードの送信に失敗しました。後ほど再試行してください。';

  @override
  String get enterAllDigitsErr => '6桁の数字をすべて入力してください。';

  @override
  String get invalidCodeErr => 'コードが無効か、すでに使用されています。';

  @override
  String get enterPasswordErr => 'パスワードを入力してください。';

  @override
  String get invalidPasswordErr => '無効なパスワードです。';

  @override
  String get passwordTooSoonErr => 'パスワードによるログインはまだ利用できません。';

  @override
  String get submitCodeBtn => 'ログイン';

  @override
  String get loginApproved => 'ログインが承認されました。Xaneoを開いています…';

  @override
  String get requestExpiredErr => 'リクエストが拒否されたか、有効期限が切れました。';

  @override
  String get rateLimitedErr => 'リクエストが多すぎます。後ほど再試行してください。';
  ...
  String get confirmDeviceRequestText =>
      'デバイスに確認リクエストが送信されました。アプリでログインを承認してください。';
