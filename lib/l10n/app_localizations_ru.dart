...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get acceptTermsRequired =>
      'Необходимо принять условия и согласие на обработку данных';
  ...
  String get aboutDescription =>
      'Современное приложение для управления и контроля систем.';
  ...
  String get poiskKontaktovChatovKanalovBotov_db66 =>
      'Поиск контактов, чатов, каналов, ботов...';
  @override
  @override
  ...
  @override
  String get kastomnyyOverleyXaneo_7d39 => 'Кастомный оверлей (стиль Telegram)';
  @override
  String get animirovannyeUvedomleniyaSBystrymOtvetom_a25d =>
      'Использовать всплывающие оверлеи вместо системных';
  @override
  ...
  String get myOtpravimKodPodtverzhdeniya_fc71 =>
      'Мы отправим код подтверждения на ваш адрес';
  @override
  @override
  ...
  String get pridumayteNadezhnyyParol_2312 =>
      'Придумайте надежный пароль (мин. 8 символов)';
  @override
  @override
  ...
  String get etoNeobyazatelnoNoPriyatno_b6a3 =>
      'Это необязательно, но так вас быстрее узнают';
  @override
  @override
  ...
  String get imyaPolzovatelyaMin5Simvolov_1232 =>
      'Имя пользователя (мин. 5 символов)';
  @override
  @override
  ...
  String get officialReleaseNotes =>
      'Официальное описание релиза доступно на GitHub';
  @override
  ...
  String get closeActionDescription =>
      'Выберите, что делать при закрытии главного окна';
  @override
  ...
  String get qrLoginSubtitle =>
      'Отсканируйте QR-код из мобильного приложения Xaneo для быстрого и безопасного входа';
  ...
  String get qrApprovalDesc =>
      'QR-код распознан. Разрешите авторизацию в мобильном приложении Xaneo.';
  ...
  String get qrVerificationCodeHint =>
      'Убедитесь, что этот код совпадает с кодом на телефоне.';
  ...
  @override
  String get qrStep2 =>
      '2. Перейдите в раздел Настройки → Устройства → Сканировать QR';
  ...
  String get codeLoginSubtitle =>
      'Введите ваш никнейм или Email для получения 6-значного кода';
  ...
  String get codeInstructionText =>
      'Шестизначный код подтверждения придёт в бот «Уведомления Xaneo» в XC, либо на вашу электронную почту (если вы не можете получить код в XC).';
  ...
  String requestCodeViaEmailIn(int seconds) =>
      'Запросить код на почту через $seconds сек.';

  @override
  String requestCodeViaPasswordIn(int seconds) =>
      'Войти по паролю через $seconds сек.';
  ...
  String get cantLoginSendToEmail =>
      'Не получается войти через бота? Отправить код на email';
  ...
  @override
  String get ravenNotificationStyle => 'Чёрная ворона';
  @override
