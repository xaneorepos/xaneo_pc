...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get animirovannyeUvedomleniyaSBystrymOtvetom_a25d =>
      'Show custom popups instead of system notifications';
  @override
  ...
  String get sobesednikViditVseChtoProishodit_c759 =>
      'Other party can see everything on your screen';
  @override
  ...
  String get groupWelcome =>
      'Welcome to the group! Chat and share files with members.';
  @override
  String get channelWelcome =>
      'Welcome to the channel! Important announcements and news are published here.';
  @override
  ...
  String get closeActionMinimizeToTraySubtitle =>
      'Closing the window minimizes it to the system tray and keeps running in background';
  @override
  String get closeActionMinimizeToTaskbarSubtitle =>
      'Closing the window minimizes it to the taskbar';
  @override
  String get closeActionExitAppSubtitle =>
      'Closing the window completely closes the application';
  @override
  ...
  String get qrLoginSubtitle =>
      'Scan the QR code using the Xaneo mobile app for fast and secure login';
  ...
  String get qrApprovalDesc =>
      'The QR code was recognized. Approve the authorization request in the Xaneo mobile app.';
  ...
  String get qrVerificationCodeHint =>
      'Make sure this code matches the code shown on your phone.';
  ...
  String get codeLoginSubtitle =>
      'Enter your username or Email to receive a 6-digit code';
  ...
  String get codeInstructionText =>
      'The 6-digit verification code will be sent to the Xaneo Notifications bot in XC, or to your Email (if you cannot receive the code in XC).';
  ...
  String requestCodeViaEmailIn(int seconds) =>
      'Request code via email in $seconds sec.';

  @override
  String requestCodeViaPasswordIn(int seconds) =>
      'Login with password in $seconds sec.';
  ...
  String get cantLoginSendToEmail =>
      'Can\'t log in via bot? Send code to email';
  ...
  @override
  String get awaitingDeviceApproval => 'Awaiting confirmation on device...';
  ...
  @override
  String get myMessageColor => 'Your message color';
  @override
  ...
  @override
  String get ravenNotificationStyle => 'Black Raven';
  @override
