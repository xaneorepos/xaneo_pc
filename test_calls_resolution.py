...
call_getters = [
    ...
    ('audioCallDesc', 'Позвонить по голосовой связи'),
    ('videoCallDesc', 'Позвонить с включенной камерой'),
    ('vhodyaschiyVyzov_905e', 'Входящий вызов'),
    ('otklonit_8b0d', 'Отклонить'),
    ('otvetit_e568', 'Ответить'),
    ('videozvonok_dd18', 'Видеозвонок...'),
    ('golosovoyZvonok_5410', 'Голосовой звонок...'),
    ('svernut_ca9f', 'Свернуть'),
    ('gruppovoyZvonok_dac1', 'Групповой звонок'),
    ('podklyuchenieKZvonku_e2cf', 'Подключение к звонку...'),
    ('sobesednik_7025', 'Собеседник'),
    ('vy_0101', 'Вы'),
...
for filepath in candidate_files:
    print("=" * 80)
    print(f"📞 ТЕСТ ЗВОНКОВ В PC ДЛЯ: {filepath.split('/')[-1]}")
    print("=" * 80)
    ...
    for g_name, label in call_getters:
